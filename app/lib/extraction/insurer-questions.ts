...
function questionFor(row: TableRow): string {
  ...
  switch (row.verdict) {
    ...
    case "CONFLICTED":
      return `One document contains contradictory statements about ${fact} under the same scope — which value is correct for you, and can the insurer confirm it in writing?`;
